...
- Целевая архитектурная ось: интерфейсы `Orchestrator`/`Repository`.
- Базовые реализации по умолчанию:
  - Kubernetes через `k8s.io/client-go`;
  - GitHub через `github.com/google/go-github`.
